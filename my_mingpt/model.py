...
from my_mingpt.utils import CfgNode as CN
...
class MySelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        # TODO: uniformly initialize self.w2 between -0.001 and 0.001
...
class GPT(nn.Module):
    ...
    @torch.no_grad()
    def generate(self, idx, max_new_tokens, temperature=1.0, do_sample=False, top_k=None, ret_probs=False):
        """
